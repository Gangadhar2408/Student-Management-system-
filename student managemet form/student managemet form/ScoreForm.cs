...
namespace student_managemet_form
{
    public partial class ScoreForm : Form
    {
        ...
        //create a funtion to show data on datagridview score
        private void showScoe()
        {
            DataGridView_student.DataSource = score.getList(new MySqlCommand("SELECT score.StudentId,student.StdFirstName,student.StdLastName,score.CourseName,score.Score,score.Description FROM student INNER JOIN score ON score.StudentId=student.Stdld;"));
        }

        private void ScoreForm_Load(object sender, EventArgs e)
        {
            //populate the comboboxwith courses name
            ...
            //to display student in datagridview
            DataGridView_student.DataSource = student.getList(new MySqlCommand("SELECT `Stdld`,`StdFirstName`,`StdLastName` FROM `student`"));
